...
type KafkaUserInterface interface {
	Create(*v1beta1.KafkaUser) (*v1beta1.KafkaUser, error)
	Update(*v1beta1.KafkaUser) (*v1beta1.KafkaUser, error)
	UpdateStatus(*v1beta1.KafkaUser) (*v1beta1.KafkaUser, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.KafkaUser, error)
	List(opts v1.ListOptions) (*v1beta1.KafkaUserList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.KafkaUser, err error)
	KafkaUserExpansion
}
...
func (c *kafkaUsers) Get(name string, options v1.GetOptions) (result *v1beta1.KafkaUser, err error) {
...
func (c *kafkaUsers) List(opts v1.ListOptions) (result *v1beta1.KafkaUserList, err error) {
...
func (c *kafkaUsers) Create(kafkaUser *v1beta1.KafkaUser) (result *v1beta1.KafkaUser, err error) {
	result = &v1beta1.KafkaUser{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("kafkausers").
...
func (c *kafkaUsers) Update(kafkaUser *v1beta1.KafkaUser) (result *v1beta1.KafkaUser, err error) {
	result = &v1beta1.KafkaUser{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kafkausers").
...
func (c *kafkaUsers) UpdateStatus(kafkaUser *v1beta1.KafkaUser) (result *v1beta1.KafkaUser, err error) {
	result = &v1beta1.KafkaUser{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kafkausers").
...
func (c *kafkaUsers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.KafkaUser, err error) {
	result = &v1beta1.KafkaUser{}
