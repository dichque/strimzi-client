...
import (
	v1beta1 "github.com/dichque/strimzi-client/pkg/client/clientset/versioned/typed/kafka/v1beta1"
...
func (c *FakeKafkaV1beta1) KafkaUsers(namespace string) v1beta1.KafkaUserInterface {
