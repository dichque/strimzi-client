...
type KafkaTopicLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.KafkaTopic, err error)
...
// List lists all KafkaTopics in the indexer.
func (s *kafkaTopicLister) List(selector labels.Selector) (ret []*v1beta1.KafkaTopic, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.KafkaTopic))
	})
	return ret, err
}
...
type KafkaTopicNamespaceLister interface {
	...
	Get(name string) (*v1beta1.KafkaTopic, error)
...
// List lists all KafkaTopics in the indexer for a given namespace.
func (s kafkaTopicNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.KafkaTopic, err error) {
...
// Get retrieves the KafkaTopic from the indexer for a given namespace and name.
func (s kafkaTopicNamespaceLister) Get(name string) (*v1beta1.KafkaTopic, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("kafkatopic"), name)
	}
	return obj.(*v1beta1.KafkaTopic), nil
}
