...
import (
	...
	kafkav1beta1 "github.com/dichque/strimzi-client/pkg/apis/kafka/v1beta1"
	versioned "github.com/dichque/strimzi-client/pkg/client/clientset/versioned"
	internalinterfaces "github.com/dichque/strimzi-client/pkg/client/informers/externalversions/internalinterfaces"
	v1beta1 "github.com/dichque/strimzi-client/pkg/client/listers/kafka/v1beta1"
...
type KafkaTopicInformer interface {
	...
	Lister() v1beta1.KafkaTopicLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KafkaV1beta1().KafkaTopics(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KafkaV1beta1().KafkaTopics(namespace).Watch(options)
			},
		},
		&kafkav1beta1.KafkaTopic{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *kafkaTopicInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kafkav1beta1.KafkaTopic{}, f.defaultInformer)
}

func (f *kafkaTopicInformer) Lister() v1beta1.KafkaTopicLister {
	return v1beta1.NewKafkaTopicLister(f.Informer().GetIndexer())
}
